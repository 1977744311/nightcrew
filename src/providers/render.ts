...
function gardenOpTask(): string[] {
  return [
    ...
    "",
    "1. Remove answered/stale entries from `questions.md` (fold durable decisions into a short note where the question was).",
    "2. In `qa.md`, drop entries that are demonstrably fixed; keep the file lean.",
    "3. Keep every file small and pointer-like: prune duplicated prose, dead references, stale plan mentions.",
    "",
