...
## Acceptance
- [ ] Proposal generation prompts explicitly instruct each lens to write candidate title, body, and rationale in the language of the goal text while preserving BACKLOG checkbox formatting rules.
- [ ] Proposal refine prompts explicitly instruct each rerun lens to follow the language of the operator feedback, and tests assert both prompt instructions are present.
